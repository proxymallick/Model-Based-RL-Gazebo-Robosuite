...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/prakash/CosMic_RAYs_X-main/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/prakash/CosMic_RAYs_X-main/X_ROS/devel)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/prakash/CosMic_RAYs_X-main/X_ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/prakash/CosMic_RAYs_X-main/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()
