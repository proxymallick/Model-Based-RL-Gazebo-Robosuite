...
echo_and_run cd "/home/prakash/CosMic_RAYs_X-main/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/prakash/CosMic_RAYs_X-main/X_ROS/src/X_UR/ee_ur5e/gripper/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/prakash/CosMic_RAYs_X-main/X_ROS/build/X_UR/ee_ur5e/gripper/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
