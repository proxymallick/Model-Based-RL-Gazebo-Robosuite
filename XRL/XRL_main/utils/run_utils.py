from XRL_main.user_config import DEFAULT_DATA_DIR, FORCE_DATESTAMP, \
                               DEFAULT_SHORTHAND, WAIT_BEFORE_LAUNCH
from XRL_main.utils.logx import colorize
from XRL_main.utils.mpi_tools import mpi_fork, msg
