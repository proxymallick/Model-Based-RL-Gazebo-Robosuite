...
from XRL_main.spaces import Box
from XRL_main.spaces import Discrete
from XRL_main.spaces import MultiDiscrete
from XRL_main.spaces import MultiBinary
from XRL_main.spaces import Tuple
from XRL_main.spaces import Dict
...
def flatdim(space):
    ...
    the space is not defined in ``XRL_main.spaces``.
    """
